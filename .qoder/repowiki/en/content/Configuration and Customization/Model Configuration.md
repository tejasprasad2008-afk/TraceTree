...
**Diagram sources**
- [detector.py:108-163](file://ml/detector.py#L108-L163)
- [trainer.py:15-96](file://ml/trainer.py#L15-L96)
- [cli.py:373-433](file://cli.py#L373-L433)
- [malicious_packages.txt:1-33](file://data/malicious_packages.txt#L1-L33)
- [clean_packages.txt:1-33](file://data/clean_packages.txt#L1-L33)
...
- Feature extraction and mapping: [map_features:29-68](file://ml/detector.py#L29-L68)
- Isolation Forest baseline: [train_baseline_model:92-101](file://ml/detector.py#L92-L101)
- Model loading and caching: [get_ml_model:108-146](file://ml/detector.py#L108-L146)
- Model update from GCS: [update_model_from_gcs:149-163](file://ml/detector.py#L149-L163)
- Severity-boosted confidence: [_severity_adjusted_confidence:180-233](file://ml/detector.py#L180-L233)
- Detection pipeline: [detect_anomaly:235-299](file://ml/detector.py#L235-L299)

**Section sources**
- [detector.py:29-68](file://ml/detector.py#L29-L68)
- [detector.py:92-101](file://ml/detector.py#L92-L101)
- [detector.py:108-146](file://ml/detector.py#L108-L146)
- [detector.py:149-163](file://ml/detector.py#L149-L163)
- [detector.py:180-233](file://ml/detector.py#L180-L233)
...
- Training call site: [RandomForestClassifier instantiation](file://ml/trainer.py#L70)
- Persistence and upload: [save and GCS upload:73-96](file://ml/trainer.py#L73-L96)

**Section sources**
- [trainer.py:70-96](file://ml/trainer.py#L70-L96)
...
Implementation references:
- Baseline training: [train_baseline_model:92-101](file://ml/detector.py#L92-L101)
- Baseline profiles: [CLEAN_BASELINES:77-89](file://ml/detector.py#L77-L89)

**Section sources**
- [detector.py:92-101](file://ml/detector.py#L92-L101)
- [detector.py:77-89](file://ml/detector.py#L77-L89)
...
- Implementation: [map_features:29-68](file://ml/detector.py#L29-L68)
...
**Section sources**
- [detector.py:29-68](file://ml/detector.py#L29-L68)
- [detector.py:254-262](file://ml/detector.py#L254-L262)
...
References:
- Model saving: [persist model.pkl:73-82](file://ml/trainer.py#L73-L82)
- GCS upload: [upload to GCS:86-96](file://ml/trainer.py#L86-L96)
- Update from GCS: [update_model_from_gcs:149-163](file://ml/detector.py#L149-L163)
- Cache invalidation: [clear_model_cache:17-20](file://ml/detector.py#L17-L20)

**Section sources**
- [trainer.py:73-96](file://ml/trainer.py#L73-L96)
- [detector.py:149-163](file://ml/detector.py#L149-L163)
- [detector.py:17-20](file://ml/detector.py#L17-L20)
...
References:
- Thresholds: [_SEVERITY_BOOST_THRESHOLDS:173-177](file://ml/detector.py#L173-L177)
- Adjustment logic: [_severity_adjusted_confidence:180-233](file://ml/detector.py#L180-L233)
- Isolation Forest mapping: [decision_function mapping:277-281](file://ml/detector.py#L277-L281)

**Section sources**
- [detector.py:173-177](file://ml/detector.py#L173-L177)
- [detector.py:180-233](file://ml/detector.py#L180-L233)
- [detector.py:277-281](file://ml/detector.py#L277-L281)
...
References:
- Model selection and prediction: [detect_anomaly:264-281](file://ml/detector.py#L264-L281)

**Section sources**
- [detector.py:264-281](file://ml/detector.py#L264-L281)
...
- [detector.py:1-11](file://ml/detector.py#L1-L11)
- [trainer.py:1-7](file://ml/trainer.py#L1-L7)
- [cli.py:373-433](file://cli.py#L373-L433)
...
References:
- Dataset checks: [load_dataset:9-13](file://ml/trainer.py#L9-L13)
- Model fallback: [get_ml_model:119-146](file://ml/detector.py#L119-L146)
- Docker preflight: [check_docker_preflight:73-109](file://cli.py#L73-L109)

**Section sources**
- [trainer.py:9-13](file://ml/trainer.py#L9-L13)
- [detector.py:119-146](file://ml/detector.py#L119-L146)
...
References:
- CLI entry points: [setup.py entry_points:30-39](file://setup.py#L30-L39)
- Training CLI: [train_cli:373-427](file://cli.py#L373-L427)
- Update CLI: [update_cli:429-432](file://cli.py#L429-L432)

**Section sources**
- [setup.py:30-39](file://setup.py#L30-L39)
- [cli.py:373-432](file://cli.py#L373-L432)
...
References:
- Ingestion main: [ingest_malwarebazaar.py main:460-618](file://ingest_malwarebazaar.py#L460-L618)
